...
namespace CGLibs.Scheduling
{
    ...
    public class MinutelySchedule : DailySchedule
    {

        public MinutelySchedule() : base()
        {
            SchedulesRecurrentType = Recurrent.Minutely;
            ...
            IsThursday = true;
            IsFriday = true;
            //minutely interval default
            Interval = 15;
        }

        //recurrent type property
        [XmlIgnore(), IgnoreDataMember()]
        public override Recurrent SchedulesRecurrentType { get { return Recurrent.Minutely; } internal set { } }
        //schedule event
        ...
        private DateTime NextScheduledRun(int padminutes = 0)
        {
            try
            {
                ...
                do
                {
                    ...
                    if (nextrun.AddMinutes(Interval).DayOfWeek != nextrun.DayOfWeek) break;

                    //move up minute interval
                    nextrun = nextrun.AddMinutes(Interval);
