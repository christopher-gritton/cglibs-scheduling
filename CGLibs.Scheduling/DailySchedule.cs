...
namespace CGLibs.Scheduling
{
    ...
    public class DailySchedule : Schedule
    {
        ...
        {
            SchedulesRecurrentType = Recurrent.Daily;
            IsSunday = true;
            IsSaturday = true;
            IsMonday = true;
            IsTuesday = true;
        ...
        public override Recurrent SchedulesRecurrentType { get { return Recurrent.Daily; } internal set { } }
        //schedule event
        ...
        private DateTime NextScheduledRun(int padminutes = 0)
        {
            try
            {
                ...
                //verify recurring day is selected
